...
Update only the memo sections affected by the completed panel verdicts. Do not rewrite untouched sections or imply that downstream work has already run.

For each updated section:
- keep the stable `section_id`
